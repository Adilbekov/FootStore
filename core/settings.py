...
# jazzmin
JAZZMIN_SETTINGS = {
    "site_title": "Our restauran",  # Заголовок сайта
    "site_header": "Restauran",  # Заголовок на экране входа
    "site_brand": "Администрация Restauran",  # Выходит на сайте вместо Django-admin.(Администрирование сайта)
    "welcome_sign": "Добро пожаловать в Restauran!",  # Приветственный текст на экране входа
